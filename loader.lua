...
local function loadPvp()
    loadRemoteScript("https://raw.githubusercontent.com/fxthaii00/BRM5/refs/heads/main/brm5-pvp/main.lua")
end

local function loadPve()
    loadRemoteScript("https://raw.githubusercontent.com/fxthaii00/BRM5/refs/heads/main/brm5-pve/main.lua")
end
...
-- Toggle GUI visibility with Home key
